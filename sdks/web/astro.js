...
class m {
  ...
  injectStyles() {
    document.getElementById("ow-styles") || (this.styleEl = document.createElement("style"), this.styleEl.id = "ow-styles", this.styleEl.textContent = p, document.head.appendChild(this.styleEl));
  }
  render() {
    var o, r;
    (o = this.overlay) == null || o.remove();
    const e = this.resolveTheme(), t = document.createElement("div");
    t.className = "ow-overlay", t.addEventListener("click", (i) => {
      i.target === t && this.handleDismiss();
    });
    const s = document.createElement("div");
    s.className = "ow-modal", s.setAttribute("data-theme", e), s.innerHTML = this.renderHTML(), t.appendChild(s), document.body.appendChild(t), this.overlay = t, this.bindEvents(s), (r = s.querySelector(".ow-alias-input")) == null || r.focus();
  }
  renderHTML() {
    var h, l;
    const e = (h = this.sessionData) == null ? void 0 : h.amount, t = ((l = this.sessionData) == null ? void 0 : l.currency) ?? "LYD", s = t === "LYD" ? 1e3 : 100, o = t === "LYD" ? 3 : 2, r = e != null ? `<div class="ow-amount"><span class="ow-amount-value">${(e / s).toFixed(o)}</span><span class="ow-amount-currency">${t}</span></div>` : "", i = `
      <div class="ow-header">
        <span class="ow-title">Astro Pay</span>
        <button class="ow-close" aria-label="Close">✕</button>
      </div>
    `, n = '<div class="ow-footer">Secured by <strong>Neptune Astro</strong> · OpenWave Standard</div>';
    let a = "";
    return this.step === "alias" ? a = `
        <div class="ow-body">
          ${r}
  ...
  bindEvents(e) {
    var t, s, o, r, i, n, a, h, l;
    (t = e.querySelector(".ow-close")) == null || t.addEventListener("click", () => this.handleDismiss()), (s = e.querySelector(".ow-cancel-btn")) == null || s.addEventListener("click", () => this.handleDismiss()), (o = e.querySelector(".ow-pay-btn")) == null || o.addEventListener("click", () => this.handleAliasContinue(e)), (r = e.querySelector(".ow-alias-input")) == null || r.addEventListener("keydown", (d) => {
      d.key === "Enter" && this.handleAliasContinue(e);
    }), (i = e.querySelector(".ow-confirm-btn")) == null || i.addEventListener("click", () => this.handleOtpConfirm(e)), (n = e.querySelector(".ow-otp-input")) == null || n.addEventListener("keydown", (d) => {
      d.key === "Enter" && this.handleOtpConfirm(e);
    }), (a = e.querySelector(".ow-back-btn")) == null || a.addEventListener("click", () => {
      this.step = "alias", this.errorMsg = "", this.render();
    }), (h = e.querySelector(".ow-done-btn")) == null || h.addEventListener("click", () => this.destroy()), (l = e.querySelector(".ow-retry-btn")) == null || l.addEventListener("click", () => {
      this.step = "alias", this.errorMsg = "", this.render();
    });
  }
  async handleAliasContinue(e) {
    ...
    try {
      const r = this.options.gatewayUrl ?? "", i = await fetch(`${r}/payments/sessions/${this.options.sessionId}/initiate`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ alias: this.aliasValue })
      }), n = await i.json();
      if (!i.ok) {
        this.errorMsg = ((o = n == null ? void 0 : n.error) == null ? void 0 : o.message) ?? "Verification failed", this.render();
        return;
      }
      this.sessionData = { ...this.sessionData, ...n }, this.step = "otp", this.render();
    } catch {
  ...
  async handleOtpConfirm(e) {
    ...
    try {
      const h = this.options.gatewayUrl ?? "", l = await fetch(`${h}/payments/sessions/${this.options.sessionId}/confirm`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ otp: t })
      }), d = await l.json();
      if (!l.ok) {
        this.step = "failed", this.errorMsg = ((o = d == null ? void 0 : d.error) == null ? void 0 : o.message) ?? "Payment failed", this.render(), (i = (r = this.options).onFailed) == null || i.call(r, { session_id: this.options.sessionId, status: "FAILED", message: this.errorMsg });
        return;
      }
      this.step = "success", this.render(), (a = (n = this.options).onSuccess) == null || a.call(n, {
